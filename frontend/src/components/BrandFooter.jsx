...
export default function BrandFooter({ className = "" }) {
  return (
    <footer
      className={[
        "border-t border-white/5 bg-dark-surface/40 backdrop-blur-sm px-6 py-4 text-center text-xs text-white/55",
        className,
      ].join(" ")}
    >
      <div className="flex flex-col items-center gap-2 sm:flex-row sm:justify-center sm:gap-6">
        ...
        <a
          ...
          className="inline-flex items-center gap-1.5 text-accent hover:text-accent-hover transition"
        >
          <svg
            width="14"
            height="14"
