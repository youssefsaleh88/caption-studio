...
export default function Editor() {
  ...
  return (
    <div className="min-h-[100dvh] flex flex-col bg-[var(--bg-base)] text-[var(--text-primary)]">
      ...
      <main className="flex-1 overflow-y-auto px-4 pt-4 pb-[calc(8rem+env(safe-area-inset-bottom))] w-full max-w-[480px] lg:max-w-[1100px] mx-auto">
        <div className="lg:grid lg:grid-cols-2 lg:gap-8 lg:items-start">
          ...
          <div className="mt-8 lg:mt-0 lg:max-h-[min(560px,calc(100vh-140px))] lg:overflow-y-auto lg:pr-1 lg:overscroll-contain">
            <CaptionList
              words={words}
        ...
        <div className="mt-10 space-y-6">
          ...
          <button
            ...
            className="cap-focus-visible w-full py-3 text-sm font-semibold text-[var(--accent-bright)] hover:underline"
          >
          ...
          <div className="text-center text-[11px] text-[var(--text-muted)] pb-2">
            ...
            <span>{t("footer.madeBy")} {BRAND.ownerName}</span>
          </div>
        </div>
      </main>

      <ActionBar words={words} videoUrl={state.videoUrl} style={style} />
    </div>
  )
}
